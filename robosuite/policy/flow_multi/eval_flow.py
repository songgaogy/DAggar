...
def resolve_eval_task_name(cfg: DictConfig, checkpoint: dict) -> str:
    return resolve_checkpoint_task_name(getattr(cfg.eval, "task_name", None), checkpoint)
...
def main(cfg: DictConfig):
    ...
    task_name = resolve_eval_task_name(cfg, checkpoint)
    ...
    if bool(cfg.eval.succ_rate):
        ...
        print(
            f"checkpoint={cfg.eval.ckpt} task={task_name} "
