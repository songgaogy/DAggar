...
from robosuite.policy.flow_unet.datasets import RobosuiteMultiViewFlowDataset
...
def main(cfg: DictConfig):
    ...
    dataset = RobosuiteMultiViewFlowDataset(
        ...
        num_train_traj=cfg.data.num_train_traj,
    ...
    global_step = 0
    print("start training flow_unet...")
    ...
    for epoch in range(int(cfg.train.epochs)):
        ...
        if (epoch + 1) % int(cfg.checkpoint.save_freq) == 0:
            ...
            checkpoint_path = os.path.join(save_dir, f"flow_unet_ep{epoch + 1:04d}_{timestamp}.pt")
