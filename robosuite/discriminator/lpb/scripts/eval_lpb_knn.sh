...
LPB_CKPT_PATH="/home/dodo/Documents/DAggar/robosuite/checkpoints/PandaLift/discriminator/lpb_dynamics/lpb-contrastive-v3"
WINDOW_LEN=10
TRANSITAION_ERROR=true
ADAPTIVE_DELTA=true
...
exec "${PYTHON_BIN}" -m robosuite.discriminator.lpb.eval_knn_discriminator \
  ...
  save_dir="${ROOT_DIR}/checkpoints/PandaLift/discriminator/lpb_knn/lpb-contrastive-v3" \
  "$@"
