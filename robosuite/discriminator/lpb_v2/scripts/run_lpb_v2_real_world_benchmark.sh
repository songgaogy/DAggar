...
OUT_DIR="${OUT_DIR:-${REPO_ROOT}/checkpoints/lpb_v2/real_world_eval/${RUN_NAME}}"
...
"${PYTHON_BIN}" -m robosuite.discriminator.lpb_v2.run_real_world_benchmark \
...
echo "[real_world][lpb_v2] wrote ${SAVE_JSON}"
