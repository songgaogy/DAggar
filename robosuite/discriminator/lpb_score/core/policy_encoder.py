...
# Default multitask ordering for stable task_index / embeddings (matches former dyn_bce.task_registry).
...
def ordered_task_names(task_names: list[str] | tuple[str, ...] | None = None) -> list[str]:
    """Canonicalize and dedupe; preserve first-seen order. If ``task_names`` is None, return ``DEFAULT_TASK_ORDER``."""
