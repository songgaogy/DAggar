...
TRAIN_ENCODER="${TRAIN_ENCODER:-1}"  # 1 -> finetune ResNet encoder (from ImageNet init)
ENCODER_LR="${ENCODER_LR:-0}"         # override training.encoder_lr; default = yaml (1.5e-4 = 30% of predictor_lr)
