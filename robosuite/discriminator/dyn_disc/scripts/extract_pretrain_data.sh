...
NNPU_CKPT="${NNPU_CKPT:-${REPO_ROOT}/checkpoints/dyn_disc/pu_bce_eval_robosuite-chunk/run_20260715_121551_PickPlaceCereal/checkpoints/pu_bce_head.pth}"
...
OUTPUT_DIR="${OUTPUT_DIR:-${DATA_ROOT}/${TASK}/discriminator-pretrain}"
