...
from robosuite.pipeline.modules.evaluation.discriminator import (
...
from robosuite.pipeline.modules.visualization.discriminator.episodes import offline_trajectory
