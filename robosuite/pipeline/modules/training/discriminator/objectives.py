...
def build_objective(
    ...
    *,
    ...
    if sampler is None:
        ...
        missing_sampler_pools = sorted(required_pools - set(sampler.pool_sizes))
        if missing_sampler_pools:
            raise ValueError(
                f"Custom sampler is missing active pools: {missing_sampler_pools}."
            )
