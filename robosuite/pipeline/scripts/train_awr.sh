...
NUM_TRAIN_STEP="${NUM_TRAIN_STEP:-150}"
VALUE_WARMUP_STEPS="${VALUE_WARMUP_STEPS:-20000}"
AWR_BETA="${AWR_BETA:-3.0}"
EXPECTILE="${EXPECTILE:-0.7}"
SUCCESS_REWARD_SCALE="${SUCCESS_REWARD_SCALE:-1.0}"   # do NOT change this! we are using -1/0 reward

# think twice before change this!
