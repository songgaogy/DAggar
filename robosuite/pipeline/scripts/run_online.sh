...
RUN="outputs/dipole/NutAssemblySquare/correct_ref_20260910_130052"  # "new" or existing run root
RUN_NAME="correct_ref"  # only used when RUN is "new"; timestamp is appended automatically
cd "${ROOT_DIR}"
