...
echo "[vis_disc_finetuned] offline_episodes=${OFFLINE_EPISODES}"
...
echo "[vis_disc_finetuned] wrote MP4 files, ${OUT_DIR}/finetuned_scores.pdf, and ${OUT_DIR}/finetuned_scores_offline.pdf"
