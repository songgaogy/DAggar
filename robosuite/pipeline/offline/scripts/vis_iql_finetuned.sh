...
#   OFFLINE_BUFFER       — iql_offline_transitions.pt override.
...
CHECKPOINT="outputs/dipole-rl-offline/PickPlaceCereal_20260713_113548_beta1_k-2_ensemble-GAE/checkpoints/iql_state_finetuned.pt"
...
echo "[vis_iql_finetuned] offline_buffer=${OFFLINE_BUFFER}"
echo "[vis_iql_finetuned] nnpu_ckpt=${NNPU_CKPT}"
echo "[vis_iql_finetuned] device=${DEVICE}"
echo "[vis_iql_finetuned] gae_lambda=${GAE_LAMBDA}"
