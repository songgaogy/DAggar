...
POLICY_CKPT="outputs/dipole_offline/PickPlaceCereal/2026-06-24_03-05-52/checkpoints/step_00014999.pt"
OMEGA=1          # DIPOLE guidance omega (omega=0 skips the negative branch => ~2x faster inference)
EVAL_EPISODES=50
