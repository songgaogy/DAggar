...
def normalize_vast_payload(payload: Any, *, source: str | Path | None = None) -> dict[str, Any]:
    ...
    raise ValueError(
        ...
        f"{VAST_SCHEMA_VERSION} or deprecated {LEGACY_VAST_SCHEMA_VERSION}."
    )
