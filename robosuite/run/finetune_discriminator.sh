...
python /home/dodo/Documents/DAggar/robosuite/robosuite/discriminator/finetune_discriminator.py \
  ...
  save_dir="/home/dodo/Documents/DAggar/robosuite/checkpoints/PandaLift/discriminator/bce/finetune" \
  train_eps=-1 \
