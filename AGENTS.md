...
- **python environment**: in this current repo, use conda environment `daggar`, or run python under `/home/dodo/miniconda3/envs/dagger/bin/python`

ask me anything if you are unclear, do NOT decide inportant details and logic by yourself. Ask me questions for my response or list the details that should let me to decide into choices questions.