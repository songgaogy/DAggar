...
Current branch is used to perform ablation study for discriminator. Use [policy](./robosuite/policy/flow_multi-update/) encoder to be the feature latent. Checkpoint: `checkpoints/multitask_6/flow_multi_ep0100.pt`
