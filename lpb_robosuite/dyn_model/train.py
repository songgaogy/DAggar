    ...
    def __init__(self, cfg):
        ...
        if self.accelerator.is_main_process:
            ...
            if self.cfg.debug:
                ...
                train_data_path_str = str(self.cfg.env.train_data_path)
                project_name = f"{self.cfg.env.name}_dyn_model"
                if 'tool_hang' in train_data_path_str:
                    project_name = "tool_hang_ph_demo_v141_dyn_model"
                elif 'square' in train_data_path_str:
                    project_name = "square_ph_demo_v141_dyn_model"
                elif 'transport' in train_data_path_str:
                    project_name = "transport_ph_demo_v141_dyn_model"
                elif 'pusht' in train_data_path_str:
                    project_name = "pusht_dyn_model"
                elif 'libero' in train_data_path_str:
        ...
        env_abs_action = self.cfg.abs_action
        if "abs_action" in self.cfg.env and self.cfg.env.abs_action is not None:
            env_abs_action = bool(self.cfg.env.abs_action)
        ...
        if 'libero' in str(self.cfg.env.train_data_path):
